...
for the frame is ten plus the number of pins knocked down on his next throw (in 
his next turn).
...
the frame score: we have to wait one or two frames to find out what the bonus is.
